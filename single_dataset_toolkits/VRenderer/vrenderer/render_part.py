...
from .blender_utils_part import (
...
def initialize(settings: InitializationSettings) -> NormalizationSpec:
    clear_scene()
    ...
    valid_render_types, index_to_name = configure_render_output(clear_normal_map=settings.clear_normal_map)
